...
public class TestBrokerRoot {
	...
	public void Test() throws Exception {
		...
		StressFactorBrokerSolver.z  = readNetCDF.z; 
		StressFactorBrokerSolver.etaR = -0.80;
		StressFactorBrokerSolver.etaE = -0.80;
		StressFactorBrokerSolver.theta = theta;
		StressFactorBrokerSolver.deltaZ = readNetCDF.spaceDelta;
		...
		ETsBrokerSolver.etaR = -0.80;
		ETsBrokerSolver.etaE = -0.80;
