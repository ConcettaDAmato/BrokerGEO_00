...
//import java.util.Arrays;
import computeGeneralStressFactor.*;
import computeStressFactor.*;
...
public class StressFactorBroker {
	...
	public void solve() {
		...
		if(step==0){
			...
			StressFactorFactory stressFactorFactory= new StressFactorFactory();
			...
			FactoryGeneralSF representativeSFFactory= new FactoryGeneralSF();
